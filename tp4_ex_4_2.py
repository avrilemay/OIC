...
image = Image.open(path+mon_image)

st.title(":blue[Exercice 4.2. Streamlit]", anchor=None)
# affichage de l'image sur streamlit
st.image(image, caption='Une photo de Bernard Arnault, PDG de LVMH et homme le plus riche de France.')

# exploitation des données EXIF
from exif import Image
img_path =path+mon_image
...
with st.form("Formulaire"):
    ...
    if pixel_x_dimension !="":
        # on modifie la caractéristiques EXIF "pixel_x_dimension"
...
fig = go.Figure(go.Scattermapbox(
    ...
    2.222675],
    lat = [64.139914, 51.500330,52.378108,48.868684,48.605059,52.516569, 0.088272,36.874834,
